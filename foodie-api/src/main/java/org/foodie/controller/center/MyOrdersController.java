package org.foodie.controller.center;
...
//    private MyOrdersService myOrdersService;
    ...
    public ServerResponse deliver(
        ...
        if (StringUtils.isBlank(orderId)) {
            return ServerResponse.errorMsg("订单ID不能为空");
        }
    ...
    public ServerResponse confirmReceive(
        ...
        if (!res) {
            return ServerResponse.errorMsg("订单确认收货失败！");
        }
    ...
    public ServerResponse delete(
        ...
        if (!res) {
            return ServerResponse.errorMsg("订单删除失败！");
        }
