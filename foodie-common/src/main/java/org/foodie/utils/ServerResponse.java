...
public class ServerResponse {
    ...
    public static ServerResponse build(Integer status, String msg, Object data) {
        return new ServerResponse(status, msg, data);
    }

    public static ServerResponse build(Integer status, String msg, Object data, String ok) {
        return new ServerResponse(status, msg, data, ok);
    }
    ...
    public static ServerResponse errorMap(Object data) {
        return new ServerResponse(501, "error", data);
    }

    public static ServerResponse errorTokenMsg(String msg) {
        return new ServerResponse(502, msg, null);
    }

    public static ServerResponse errorException(String msg) {
    ...
    public ServerResponse(Integer status, String msg, Object data, String ok) {
        this.status = status;
        this.msg = msg;
        this.data = data;
        this.ok = ok;
